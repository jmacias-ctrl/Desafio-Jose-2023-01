    ...
    <div class="container-sm d-flex flex-column border rounded shadow">
        ...
        <div class="table-responsive caption-top">
            <div class="d-flex">
                ...
                <a id="crearButton" class="btn btn-primary" href="{{ url('admin/gestion_artistas/create') }}" role="button">Crear nuevo artista</a>
            </div>
                                ...
                                <div class="btn-group">
                                    ...
                                    <ul class="dropdown-menu">
                                        <li><a class="dropdown-item"
                                                href="{{ url('admin/gestion_artistas/' . $artista->id . '/edit') }}"><span
                                                    class="material-symbols-outlined">
                                                    edit</a></li>
                                        <li>
                                            <form action="{{ url('admin/gestion_artistas/' . $artista->id) }}" method="POST">
                                                @csrf
                                                {{ method_field('DELETE') }}
                                                <div class="d-flex">
